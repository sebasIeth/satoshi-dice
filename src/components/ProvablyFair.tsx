...
const ProvablyFair: React.FC<ProvablyFairProps> = ({ lastResult, chainConfig }) => {
    const [isOpen, setIsOpen] = useState(false);
    const [copied, setCopied] = useState(false);

    const explorerTxUrl = lastResult ? chainConfig.explorerTxUrl(lastResult.txHash) : '';
    const explorerName = chainConfig.chain.blockExplorers?.default?.name || 'Explorer';
