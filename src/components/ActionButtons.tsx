                    ...
                    {isRolling ? (
                        ...
                        <>
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-xs text-secondary/80 font-bold tracking-widest">ROLL OVER</span>
                            </div>
                            <span className="text-2xl font-mono font-bold text-white">&gt; {targetValue}</span>
                            <div className="flex items-center gap-1 mt-0.5">
                                <span className="text-[10px] text-gray-500 font-mono">Win:</span>
                                <span className="text-sm text-secondary font-bold font-mono">${payoutOver}</span>
                            </div>
                        </>
                    )}
                </div>
